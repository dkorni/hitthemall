...
public class ToonDiffuseDissolveEditor : ShaderGUI
{
	...
	string GetAssetPath()
	{
		string name = "ToonDiffuseDissolveEditor";
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		else
		{
			...
			Texture titleTex = AssetDatabase.LoadAssetAtPath(GetAssetPath() + "ToonDiffuseDissolve.png", typeof(Texture2D)) as Texture2D;//Get Title image
