...
public class ToonDiffuseEditor : ShaderGUI {
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		else
		{
			...
			Texture titleTex = AssetDatabase.LoadAssetAtPath(GetAssetPath() + "ToonDiffuse.png", typeof(Texture2D)) as Texture2D;//Get Title image
