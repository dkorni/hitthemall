...
public class ToonDiffuseMultiTextureEditor : ShaderGUI {
	...
	string GetAssetPath()
	{
		string name = "ToonDiffuseMultiTextureEditor";
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		else
		{
			...
			Texture titleTex = AssetDatabase.LoadAssetAtPath(GetAssetPath() + "ToonDiffuseMultiTexture.png", typeof(Texture2D)) as Texture2D;//Get Title image
